...
public class TeacherPageController implements Initializable {
    ...
    public void onTableItemSelect(){
        ...
        if(index <= -1){
            ...
            txtAddId.setText(col_sid.getCellData(index).toString());
            txtAddName.setText(col_sname.getCellData(index).toString());
            txtAddCourse.setText(col_scourse.getCellData(index).toString());
        }
    }
